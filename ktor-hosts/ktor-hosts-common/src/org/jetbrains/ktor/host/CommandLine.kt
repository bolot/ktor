...
fun commandLineEnvironment(args: Array<String>): ApplicationHostEnvironment {
    ...
    val environment = applicationHostEnvironment {
        ...
        val sslPort = deployment.secure.port
        if (sslPort != null) {
            val sslKeyStorePath = deployment.secure.keyStore
            val sslKeyStorePassword = deployment.secure.keyStorePassword
            val sslPrivateKeyPassword = deployment.secure.privateKeyPassword
            val sslKeyAlias = deployment.secure.keyAlias
